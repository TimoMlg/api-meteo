...
function btnGetMethod() {
    ...
    var current_hour; //heure actuelle de la ville
...
const callApiSunriseSunset = function(lat, lon) {
    ...
    .then(dataSunrise => {
        $.get(urlOpenWeather, function (dataOpenWeather, status) {
            ...
            //console.log("Heure de sunrise : " + data.results.sunrise);
            console.log("Heure de sunrise : " + sunriseTime); 
            console.log("Heure de sunset : " + sunsetTime);
